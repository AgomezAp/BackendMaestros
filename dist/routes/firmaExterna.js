...
import { enviarSolicitudFirma, obtenerActaPorToken, firmarActaConToken, rechazarActaConToken, reenviarCorreoFirma, obtenerEstadoFirma } from '../controllers/firmaExterna.js';
const router = Router();
// ==========================================
