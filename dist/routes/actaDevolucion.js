...
import { obtenerDispositivosEntregados, obtenerActasDevolucion, obtenerActaDevolucionPorId, crearActaDevolucion, enviarSolicitudFirmaDevolucion, obtenerActaDevolucionPorToken, firmarActaDevolucionConToken, rechazarActaDevolucionConToken, reenviarCorreoDevolucion } from '../controllers/actaDevolucion.js';
const router = Router();
// ==========================================
